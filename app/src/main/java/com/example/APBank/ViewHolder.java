...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    private com.example.APBank.ViewHolder.ClickListener mClickListener;
    ...
    public void setOnClickListener(com.example.APBank.ViewHolder.ClickListener clickListener){
